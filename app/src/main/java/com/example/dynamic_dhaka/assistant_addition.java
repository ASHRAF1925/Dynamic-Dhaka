...
/**
 * This Activity works for adding the assistant
 */

public class assistant_addition extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assistant_addition);
       ...
       final boolean[] starter =new boolean[1];
        ...
        ref= FirebaseDatabase.getInstance().getReference().child("assistant_id");
        ref.addValueEventListener(new ValueEventListener() {
            /**
             * Geting the assistent id from the database
             * @param snapshot
             */
            @Override
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            /**
             * This method checks the identities and set the identities to the database
             * @param v
             */
            @Override
            public void onClick(View v) {
                ...
                ref[0].addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        {
                            /**
                             * Checking the NID NUMBER NAME AND DOB
                             */
                ...
                if(starter[0]) {
                    ...
                    DatabaseReference data_in = dat_in.getReference("Assistants");
                    ...
                    /**
                     * Seting the serial to database
                     */
                    DatabaseReference idt = FirebaseDatabase.getInstance().getReference("assistant_id");
                    idt.setValue(serial[0]);
                    /////id insert finsih
                    Intent intent = new Intent(assistant_addition.this, Auth_menu.class);
